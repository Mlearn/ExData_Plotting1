plot4 <- function() {
  ...
  par(mfrow = c(2,2))
  with(dat, {
    plot(1:length(Global_active_power), Global_active_power, xlab = "", xaxt="n", type = "l", ylab = "Global Active Power (Kilowatts)")
    ...
    plot(1:length(Global_reactive_power), Global_reactive_power, xlab = "", xaxt="n", type = "l", ylab = "Global_reactive_power")
